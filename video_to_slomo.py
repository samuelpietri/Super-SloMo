...
def create_video(dir):
    ...
    error = ""
    print('{} -r {} -i {}/%d.png -vcodec libx264 -crf 4  -pix_fmt yuv420p {}'.format(ffmpeg_path, args.fps, dir, args.output))
    retn = os.system('{} -r {} -i {}/%d.png -vcodec libx264 -crf 4  -pix_fmt yuv420p "{}"'.format(ffmpeg_path, args.fps, dir, args.output))
    if retn:
